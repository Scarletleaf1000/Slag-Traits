...
import me.scarletleaf1000.slagtraits.recipe.smithing.PartSwapRules;
...
public class PartSwapRecipe implements SmithingRecipe {
    ...
    public boolean isBaseIngredient(ItemStack stack) {
        return PartSwapRules.isModularTool(stack);
    }

    @Override
    public boolean isAdditionIngredient(ItemStack stack) {
        return PartSwapRules.isReplacementPart(stack);
    }
